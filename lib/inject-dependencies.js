      ...
      forEach(function (filePath) {
        if (typeof fileType.replace[blockType] === 'function') {
          newFileContents += spacing + fileType.replace[blockType](filePath);
            ...
            newFileContents += spacing + fileType.replace[blockType].replace('{{filePath}}', "wwwwroot/lib/" + $.path.basename(filePath, $.path.extname(filePath)) + "/" + $.path.basename(filePath));

            gulp.src("./" + filePath)
                .pipe(gulp.dest('./wwwroot/lib/' + $.path.basename(filePath, $.path.extname(filePath)) + "/" + $.path.basename(filePath)));
